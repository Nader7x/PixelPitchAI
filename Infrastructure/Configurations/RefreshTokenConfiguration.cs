...
public class RefreshTokenConfiguration : IEntityTypeConfiguration<RefreshToken>
{
    public void Configure(EntityTypeBuilder<RefreshToken> builder)
    {
        ...
        builder.Property(r => r.Created).IsRequired().HasColumnType("timestamp with time zone");

        builder.Property(r => r.Expires).IsRequired().HasColumnType("timestamp with time zone");

        builder.Property(r => r.Revoked).HasColumnType("timestamp with time zone");
