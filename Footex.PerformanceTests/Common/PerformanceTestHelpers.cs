...
public class PerformanceTestHelpers
{
    ...
    public static string[] GetRealisticSearchQueries()
    {
        ...
        [
            // Player names
            "messi", "ronaldo", "neymar", "mbappe", "haaland", "salah", "de bruyne",
            "lewandowski", "benzema", "modric", "kane", "son", "rashford",

            // Team names
            "manchester united", "liverpool", "barcelona", "real madrid", "bayern munich",
            "juventus", "psg", "arsenal", "chelsea", "tottenham", "city", "milan",
            ...
            // Positions
            "midfielder", "striker", "defender", "goalkeeper", "winger", "centre-back",

            // Combinations
            "brazilian striker", "english midfielder", "spanish defender",
            "manchester player", "liverpool forward", "barcelona midfielder"
        ];
    }
    ...
    public static string[] GetRealisticNationalities()
    {
        return new[]
        {
            ...
            "Portugal", "Netherlands", "Italy", "Belgium", "Croatia", "Poland"
        };
    }
    ...
    public static string[] GetRealisticCountries()
    {
        return new[]
        {
            ...
            "Argentina", "Netherlands", "Portugal", "Belgium"
        };
    }
