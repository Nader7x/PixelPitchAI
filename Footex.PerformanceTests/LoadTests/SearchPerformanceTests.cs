...
public class SearchPerformanceTests : IClassFixture<FootexWebApplicationFactory>
{
    ...
    public void TeamSearch_PerformanceTest()
    {
        ...
        .WithLoadSimulations(
            Simulation.Inject(rate: 12, interval: TimeSpan.FromSeconds(1), during: TimeSpan.FromMinutes(2)),
            Simulation.KeepConstant(copies: 6, during: TimeSpan.FromMinutes(1))
        );
    ...
    public void MatchSearch_PerformanceTest()
    {
        ...
        .WithLoadSimulations(
            Simulation.Inject(rate: 8, interval: TimeSpan.FromSeconds(1), during: TimeSpan.FromMinutes(2)),
            Simulation.KeepConstant(copies: 4, during: TimeSpan.FromMinutes(1))
        );
    ...
    public void MixedSearch_LoadTest()
    {
        ...
        .WithWeight(40)
        .WithLoadSimulations(Simulation.KeepConstant(copies: 6, during: TimeSpan.FromMinutes(3)));
        ...
        .WithWeight(30)
        .WithLoadSimulations(Simulation.KeepConstant(copies: 4, during: TimeSpan.FromMinutes(3)));
