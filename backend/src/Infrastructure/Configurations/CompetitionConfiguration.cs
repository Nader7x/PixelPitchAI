...
public class CompetitionConfiguration : IEntityTypeConfiguration<Competition>
{
    public void Configure(EntityTypeBuilder<Competition> builder)
    {
        ...
        builder.Property(c => c.Name).IsRequired().HasMaxLength(200).HasColumnType("varchar(200)");

        builder.Property(c => c.Description).HasMaxLength(500).HasColumnType("varchar(500)");
        builder.Property(c => c.Logo).HasMaxLength(500).HasColumnType("varchar(500)");
        builder.Property(c => c.Country).HasMaxLength(100).HasColumnType("varchar(100)");
