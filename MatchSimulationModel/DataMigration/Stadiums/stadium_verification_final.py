...
def verify_stadium_system():
    ...
    try:
        ...
        print(f"\n🏗️ STADIUM DETAILS (Sample)")
        print("-" * 50)

        for stadium in stadiums[:3]:  # Show first 3 stadiums as sample
