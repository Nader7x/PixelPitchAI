...
{
    [JsonPropertyName("simulation_id")] public string SimulationId { get; init; } = string.Empty;
    ...
    [JsonPropertyName("last_updated")] public DateTime LastUpdated { get; init; } = DateTime.UtcNow;
...
public class SimulationResultResponse
{
    ...
    [JsonPropertyName("home_team_score")] public int? HomeTeamScore { get; init; }

    [JsonPropertyName("away_team_score")] public int? AwayTeamScore { get; init; }

    [JsonPropertyName("events_count")] public int EventsCount { get; init; }

    [JsonPropertyName("execution_time")] public double ExecutionTime { get; init; }
    ...
    [JsonPropertyName("result_url")] public string? ResultUrl { get; init; }
}
...
public class RegisterWebhookRequest
{
    ...
    [JsonPropertyName("events")] public List<string> Events { get; set; } = ["completion", "failure"];
}

public class ApiRegisterWebhookRequest
{
    [JsonPropertyName("webhook_url")] public string WebhookUrl { get; set; } = string.Empty;
...
public class ApiRegisterWebhookResponse
{
...
public class RegisterWebhookResponse
{
    ...
    [JsonPropertyName("webhook_id")] public string? WebhookId { get; init; }
...
/// <summary>
///     Webhook notification payload received from the model API
/// </summary>
public class WebhookNotificationPayload
{
    [JsonPropertyName("simulation_id")] public string SimulationId { get; set; } = string.Empty;

    [JsonPropertyName("status")] public string Status { get; set; } = string.Empty; // "completed", "failed", etc.
